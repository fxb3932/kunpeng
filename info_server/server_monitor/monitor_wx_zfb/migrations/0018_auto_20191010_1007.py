# Generated by Django 2.1.5 on 2019-10-10 10:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('monitor_wx_zfb', '0017_delete_trans_flow'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plat_area', models.CharField(blank=True, default='0', max_length=64, null=True)),
                ('plat_bu', models.CharField(blank=True, default='0', max_length=64, null=True)),
                ('plat_team', models.CharField(blank=True, default='0', max_length=64, null=True)),
                ...
                ('trans_chnl', models.CharField(blank=True, default='0', max_length=64, null=True)),
