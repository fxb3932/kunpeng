...
(function ($) {
    var w2grid = function(options) {
        ...
        this.textSearch      = 'contains'; // default search type for text FXB
...
//                    break;
        ...
        initSearches: function () {
            ...
            for (var s = 0; s < this.searches.length; s++) {
                ...
                if (search.type == 'text') operator = 'contains'; // default operator for text FXB
        ...
        getCellHTML: function (ind, col_ind, summary, col_span) {
            ...
            if (col.info != null) {
                if (!col.info.icon) col.info.icon = 'w2ui-icon-myview';
                infoBubble += '<span class="w2ui-myview '+ col.info.icon +'" style="'+ (col.info.style || '') + '" '+
        ...
        showBubble: function (ind, col_ind) {
            ...
            var rec  = this.records[ind];
            var el   = $(this.box).find('#grid_'+ this.name +'_data_'+ ind +'_'+ col_ind + ' .w2ui-myview');
